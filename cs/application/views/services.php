						...
						<div class="cell-8">
							<div class="row">
								<div class="block fx" data-animate="fadeInLeft">
									<h3 class="block-head">Why They Choosed Us ?</h3>
									...
									Pellentesque imperdiet purus quis metus imperdiet fermentum. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
									<ul class="list prim list-ok">
										...
										<li>Feugiat sodales pretium massa euismod tempus suspendisse hendrerit</li>
									</ul>
								</div>
							</div>
						</div>
